...
function F() {
	...
	function g(t, e, r, n, s, f) {
		return (
			(r = f.ref),
			{ $$typeof: p, type: t, key: e, ref: r !== void 0 ? r : null, props: f }
		);
	}
	function K(t, e) {
...
var x;
function tt() {
	return x || ((x = 1), (h.exports = F())), h.exports;
}
var L = tt();
const et = V(L),
	rt = J({ __proto__: null, default: et }, [L]);
export { rt as R, tt as a, V as g, L as r };
