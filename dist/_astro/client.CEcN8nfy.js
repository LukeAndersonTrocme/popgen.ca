import { a as zd, r as Pt } from "./index.BB0SbgvW.js";
import { r as Ad } from "./index.BKWGwx0l.js";
var Jc = { exports: {} },
	ie = {},
	wc = { exports: {} },
	Wc = {}; /**
		...
		switch (t) {
			...
			case "option":
				for (var U in a)
					if (
						((s = a[U]),
						a.hasOwnProperty(U) && s != null && !u.hasOwnProperty(U))
					)
						switch (U) {
							case "selected":
								l.selected = !1;
			...
			case "menuitem":
				...
				for (d in u)
					if (
						((s = u[d]),
						(m = a[d]),
						u.hasOwnProperty(d) && s !== m && (s != null || m != null))
					)
						switch (d) {
							case "children":
							case "dangerouslySetInnerHTML":
